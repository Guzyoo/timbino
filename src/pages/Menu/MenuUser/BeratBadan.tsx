...
type BeratBadanScreenNavigationProp = StackNavigationProp<
  RootParamList,
  'BeratBadan'
>;
const BeratBadan = () => {
  const navigation = useNavigation<BeratBadanScreenNavigationProp>();
  return (
    <ScrollView
      ...
      <View style={styles.container1}>
        ...
        <Text style={styles.timbangan}>TIMBANGAN TERAKHIR</Text>
      </View>
      ...
      <View style={styles.container2}>
        ...
        <View style={styles.card}>
          <View style={styles.cardContainer}>
            ...
            <Text style={styles.berat}>7,4 Kg</Text>
          </View>
        </View>
      </View>
    </ScrollView>
